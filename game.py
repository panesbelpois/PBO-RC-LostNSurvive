...
def run_game():
    pygame.init()
    pygame.display.set_mode((1000, 600))  # Initialize display first

    font = pygame.font.SysFont("Arial", 26, bold=True)
    clock = pygame.time.Clock()
    screen = pygame.display.set_mode((1000, 600))
    
    # Load images after pygame is initialized
    ...
    crew_bullet_img = pygame.transform.smoothscale(crew_bullet_img, (30, 30))
    ...
    def start_battle(crew_list):
        # Create battle with proper images
        ...
        # Set bullet images
        battle.crew_bullet_img = crew_bullet_img
        battle.enemy_bullet_img = enemy_bullet_img
        ...
        while running:
            ...
            if battle.crew_selection_phase:
                ...
                # Use the battle's own draw method
                battle.draw_battle_scene(screen, font, battle_background, enemy_image)
        ...
        # Update crew stats back to original crew
        for c in crew_list:
    ...
    while running:
        for event in pygame.event.get():
            ...
            if in_battle and current_battle:
                if battle_phase == 'crew_select':
                    ...
                    if event.type == pygame.MOUSEBUTTONDOWN:
                        mouse_pos = pygame.mouse.get_pos()
                        for i, path in enumerate(current_battle.crew_avatar_paths):
                            x = 150 + i * 150
                            y = 200
                            ...
                            if avatar_rect.collidepoint(mouse_pos):
                                ...
                                crew.avatar = pygame.image.load(path).convert_alpha()
                    ...
                    if event.type == pygame.KEYDOWN:
                        if event.key == pygame.K_SPACE and current_battle.selected_crew:
                            ...
                            if current_battle.battle_finished:
                                # Update crew HP back to original crew
                                for c in my_wagon.crew_list:
                ...
                if show_story:
                    ...
                    if event.key == pygame.K_n or event.key == pygame.K_a:
                        ...
                        if "musuh" in current_event_message.lower():
                            ...
                            # Set bullet images after battle creation
                            current_battle.crew_bullet_img = crew_bullet_img
                            current_battle.enemy_bullet_img = enemy_bullet_img
        ...
        if in_battle and current_battle:
            ...
            if battle_phase == 'crew_select':
                ...
                current_battle.draw_avatar_selection(screen, font)
                
            elif battle_phase == 'battle':
                keys = pygame.key.get_pressed()
                current_battle.handle_movement_input(keys)
                current_battle.update()
                current_battle.draw_battle_scene(screen, font, battle_background, enemy_image)
        ...
        if show_story:
            ...
            if show_choices:
                ...
                # Display various menus and status screens
                if show_crew_status:
                    status_width = 400
                    status_height = 300
                ...
                if show_inventory_menu:
                    ...
                    draw_text(screen, font, "Panah Atas/Bawah: Pilih | ←/→: Food/Drink | Enter: Pakai | Esc: Tutup", inv_x + inv_width//2, inv_y + inv_height - 30, (200,200,200), center_x=True)

                # Game over/win conditions
                if not game_over and not game_finished:
                    if my_wagon.position >= 120:
                        game_finished = True
                    elif (day >= 5 and my_wagon.position < 170) or (game_started and (len(my_wagon.crew_list) == 0 or all(c.is_dead for c in my_wagon.crew_list))):
                        game_over = True

                if game_over:
                    screen.fill((30, 0, 0))
                    draw_text(screen, font, "GAME OVER", screen_width//2, screen_height//2 - 30, (255, 50, 50), center_x=True)
                    if day >= 5 and my_wagon.position < 170:
                        draw_text(screen, font, "Hari habis dan kamu belum sampai tujuan!", screen_width//2, screen_height//2 + 10, (255,255,255), center_x=True)
                    else:
                        draw_text(screen, font, "Semua kru telah mati atau habis.", screen_width//2, screen_height//2 + 10, (255,255,255), center_x=True)
        ...
        if show_dead_crew:
            ...
            draw_text(screen, font, "Tekan [G] atau klik tombol untuk menutup", status_x + status_width//2,
                    status_y + status_height - 40, (200, 200, 200), center_x=True)
