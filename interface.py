...
def draw_dead_crew_list(screen, font, wagon, screen_width):
    ...
    box_width = 300
    box_height = 30 + (len(wagon.dead_crew_list) * 30)
    ...
    draw_text(screen, font, "Dead Crew", box_x + 10, box_y + 10, color=(255, 200, 200))

    for i, crew in enumerate(wagon.dead_crew_list):
        draw_text(screen, font, f"- {crew.nama}", box_x + 20, box_y + 40 + (i * 30), color=(255, 200, 200))
